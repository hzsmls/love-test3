...
The repository includes `.github/workflows/deploy-pages.yml`. Upload the project to a GitHub repository, then open **Settings → Pages** and set **Source** to **GitHub Actions**. Each push to `main` will build and publish the site at `https://YOUR-USERNAME.github.io/REPOSITORY-NAME/`. The workflow uses a Vite static build for GitHub Pages.
